  ...
  var Select = function (_Component) {
    ...
    createClass(Select, [{
      ...
      value: function buildMenuOptions(props, selectValue) {
        ...
        var parseOptions = function parseOptions(acc, item, itemIndex) {
          if (item.options) {
            var items = item.options;

            var children = items.map(function (child, i) {
              return parseOptions(acc, child, itemIndex + '-' + i);
            }).filter(Boolean);
            return {
              type: 'group',
              key: _this3.getElementId('group') + '-' + itemIndex,
              data: item,
              options: children
            };
          } else {
        ...
        var renderGroup = function renderGroup(props) {
          ...
          return React__default.createElement(
            ...
            _extends({}, commonProps, group, {
              ...
              label: _this5.formatGroupLabel(props.data)
            }),
            props.options.map(function (option) {
              return option.type === 'group' ? renderGroup(option) : render(option);
            })
          );
        };
